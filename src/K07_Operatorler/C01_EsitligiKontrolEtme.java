...
public class C01_EsitligiKontrolEtme {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(a=b); //b'nin değerini a'ya atama yapar bu 8

        System.out.println(c=a-b);//c ye a-b yi atar 0

        System.out.println(a!=b); //a eişt değildir b ye cvp true

        System.out.println(a!=c); //5!=3 true
        ...
        //char data türü matematiksel işlemlerde
        //ASCII table karşılığı değerlerr ile işleme girer
        //biz küçük yerine büyük yerine sonra düşünebiliriz.
