...
public class C01_BaziExceptionTurleri {
    ...
    public static void main(String[] args) {
        ...
        String str = null;
        String s;
        //System.out.println(s); //java: variable s might not have been initialized

        String t = "";
        System.out.println(t); //t variable'ina değer atanmıştır. bu sebeple değer atanmamış kabul edilmez

        System.out.println(str); //null
        System.out.println("Kerem "+str); //Kerem null yazdırır

        //System.out.println(str.length()); //NullPointerException hatası verdi
        //System.out.println(str.toUpperCase()); ////NullPointerException hatası verdi
